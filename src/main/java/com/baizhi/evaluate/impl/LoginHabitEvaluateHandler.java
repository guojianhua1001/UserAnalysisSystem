 ...
 * 登录习惯风险评估
 */
public class LoginHabitEvaluateHandler implements EvaluateHandler {
    @Override
    public void invoke(EvaluateData evaluateData, HistoryData historyData, EvalReport evalReport, EvaluateChain evaluateChain) {
        ...
        reportItems.put(EvaluateType.LOGIN_HABIT_EVAL, LoginEvaluate.loginHabitsEval(evaluateData.getCurrentTime(), historyData.getHistoricalHabits(), 10));
        //评估链的调用
