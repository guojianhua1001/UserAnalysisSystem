 ...
 * 输入特征风险评估
 */
public class InputFeatureEvaluateHandler implements EvaluateHandler {
    @Override
    public void invoke(EvaluateData evaluateData, HistoryData historyData, EvalReport evalReport, EvaluateChain evaluateChain) {
        ...
        reportItems.put(EvaluateType.INPUT_FEATURE_EVAL, LoginEvaluate.inputFeatureEval(evaluateData.getInputFeature(), historyData.getHistoryVectors()));
        //评估链的调用
