 ...
 * 异地登录风险评估
 */
public class RegionLoginEvaluateHandler implements EvaluateHandler {
    @Override
    public void invoke(EvaluateData evaluateData, HistoryData historyData, EvalReport evalReport, EvaluateChain evaluateChain) {
        ...
        reportItems.put(EvaluateType.REGION_EVAL, LoginEvaluate.regionLoginEval(evaluateData.getRegion(), historyData.getHistoryCities()));
        //评估链的调用
